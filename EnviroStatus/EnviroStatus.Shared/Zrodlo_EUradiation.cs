...
//using Microsoft.VisualBasic.CompilerServices;
    ...
    // TYLKO POCZATEK TAK NAPRAWDE NIE DZIALA

namespace EnviroStatus
{
    public class Source_EUradiation : Source_Base
    {
        protected override string SRC_SETTING_NAME { get; } = "sourceEUrad";
        protected override string SRC_SETTING_HEADER { get; } = "EU Radioactivity Monitoring";
        protected override string SRC_RESTURI_BASE { get; } = "https://remap.jrc.ec.europa.eu/api/";
        public override string SRC_POMIAR_SOURCE { get; } = "EUremon";

        protected override string SRC_URI_ABOUT_EN { get; } = "https://remap.jrc.ec.europa.eu/Help/Simple.aspx";
        protected override string SRC_URI_ABOUT_PL { get; } = "https://remap.jrc.ec.europa.eu/Help/Simple.aspx";
