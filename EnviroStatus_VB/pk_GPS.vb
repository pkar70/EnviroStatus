...
#Region "GPS"
    Public goGpsPoint As Point

    Public Async Function GetCurrentPoint() As Task(Of Point)
        ' Dim oPoint As Point

        goGpsPoint.X = pkar.GetSettingsString("settLatitude")
        goGpsPoint.Y = pkar.GetSettingsString("settLongitude")
        ' udajemy GPSa
        If Not pkar.GetSettingsBool("settUseGPS") Then Return goGpsPoint
