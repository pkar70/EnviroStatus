...
#Region "String"
    ...
    Public Sub SetSettingsString(sName As String, oTBox As TextBox, bRoam As Boolean)
        SetSettingsString(sName, oTBox.Text, bRoam)
    End Sub

    Public Sub SetSettingsString(sName As String, oTBox As TextBlock, bRoam As Boolean)
        SetSettingsString(sName, oTBox.Text, bRoam)
    End Sub
